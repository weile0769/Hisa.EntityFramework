...
using Hisa.EntityFramework.Benchmarks.Entities;
using Hisa.EntityFramework.Providers;
using Microsoft.Extensions.DependencyInjection;
using SqlSugar;

namespace Hisa.EntityFramework.Benchmarks.BenchmarkTests;
...
public class SqlQuerySingleNoSqlParameterBenchmarkTest
{
    ...
    /// <summary>
    ///     HisaEntityFramework-SQL非参数化单实体查询性能测试案例
    /// </summary>
    [Benchmark]
    public void SqlQuerySingleNoSqlParameterForHisaEntityFrameworkBenchmarkTest()
    {
        var sql = $@"
select id          as Id,
