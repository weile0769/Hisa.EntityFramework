...
public interface IAdoProvider
{
    ...
    /// <typeparam name="T">查询结果对象类型</typeparam>
    /// <returns>查询结果实体对象</returns>
    Task<T> SqlQuerySingleAsync<T>(string sql, SqlParameter[] parameters, CancellationToken token = default);
    ...
    /// <typeparam name="T">查询结果对象类型</typeparam>
    /// <returns>查询结果实体对象列表</returns>
    Task<List<T>> SqlQueryAsync<T>(string sql, SqlParameter[] parameters, CancellationToken token = default);
    ...
    /// <param name="token">取消令牌</param>
    /// <returns>影响行数</returns>
    Task<int> ExecuteCommandAsync(string sql, SqlParameter[] parameters, CancellationToken token = default);
    ...
    /// <param name="token">取消令牌</param>
    /// <returns>数据结果集</returns>
    Task<DataSet> GetDataSetAsync(string sql, SqlParameter[] parameters, CancellationToken token = default);
    ...
    /// <param name="token">取消令牌</param>
    /// <returns>数据表格</returns>
    Task<DataTable> GetDataTableAsync(string sql, SqlParameter[] parameters, CancellationToken token = default);
