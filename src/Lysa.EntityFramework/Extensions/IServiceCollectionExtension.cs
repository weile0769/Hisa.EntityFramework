...
using Lysa.EntityFramework;
using Lysa.EntityFramework.Builders;
using Lysa.EntityFramework.Caching;
using Lysa.EntityFramework.Expressions;
...
public static class IServiceCollectionExtension
{
    ...
    /// <returns></returns>
    public static IEntityFrameworkBuilder AddLysaSqlEntityFramework(this IServiceCollection services, Action<EntityFrameworkOptions> optionAction)
    {
        //配置选注册
